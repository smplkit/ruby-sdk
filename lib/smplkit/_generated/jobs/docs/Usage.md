...
| **active_jobs** | **Integer** | Number of permanent jobs (recurring and manual) counted against the plan&#39;s job limit. |  |
| **active_jobs_limit** | **Integer** | Maximum permanent jobs the plan allows (&#x60;-1&#x60; means unlimited). |  |
