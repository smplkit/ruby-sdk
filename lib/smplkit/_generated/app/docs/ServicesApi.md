...
api_instance = SmplkitGeneratedClient::App::ServicesApi.new
opts = {
  filter_search: 'filter_search_example', # String | Case-insensitive substring match against the service `key` and `name`. A service is returned if either field contains the search term.
...
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **filter_search** | **String** | Case-insensitive substring match against the service &#x60;key&#x60; and &#x60;name&#x60;. A service is returned if either field contains the search term. | [optional] |
