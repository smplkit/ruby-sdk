...
| ---- | ---- | ----------- | ----- |
| **key** | **String** | Entity identifier within the context type (e.g. &#x60;alice-123&#x60;). Together with &#x60;context_type&#x60; it forms the composite &#x60;id&#x60; &#x60;context_type:key&#x60;. Always populated in responses; declared optional only so SDK consumers can construct a draft Context without a key. Set by the bulk-register API; not editable. | [optional][readonly] |
