...
api_instance = SmplkitGeneratedClient::App::ContextsApi.new
id = 'id_example' # String | 
context_request = SmplkitGeneratedClient::App::ContextRequest.new({data: SmplkitGeneratedClient::App::ContextResource.new({type: 'context', attributes: SmplkitGeneratedClient::App::Context.new({key: 'key_example', context_type: 'context_type_example'})})}) # ContextRequest | 
