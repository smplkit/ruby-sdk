...
module SmplkitGeneratedClient::App
  class AuthApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [AuthTokenResponse]
    def refresh_auth_token(opts = {})
      data, _status_code, _headers = refresh_auth_token_with_http_info(opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(AuthTokenResponse, Integer, Hash)>] AuthTokenResponse data, response status code and response headers
    def refresh_auth_token_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: AuthApi.refresh_auth_token ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"AuthApi.refresh_auth_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: AuthApi#refresh_auth_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
