  ...
  class UsageApi
    ...
    def list_logging_usage_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsageApi.list_logging_usage ...'
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"UsageApi.list_logging_usage",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsageApi#list_logging_usage\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
