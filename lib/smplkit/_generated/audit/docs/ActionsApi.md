...
| [**list_resource_types**](ActionsApi.md#list_resource_types) | **GET** /api/v1/resource_types | List Resource Types |
...
begin
  ...
  puts "Error when calling ActionsApi->list_resource_types: #{e}"
end
```
...
begin
  ...
  puts "Error when calling ActionsApi->list_resource_types_with_http_info: #{e}"
end
```
